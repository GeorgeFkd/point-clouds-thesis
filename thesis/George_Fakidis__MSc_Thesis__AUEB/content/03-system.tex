...
provided with pretrained weights from a library we used(open3d-ml, discussed in section \ref{sec:system:sec2}). The results looks like the figure \ref{fig:system:4}.
\begin{figure}[htb]
