...
details.
\href{https://github.com/isl-org/Open3D}{\emph{Open3D}} is a C++ based library with a python wrapper for convenience made by the Intelligent Systems Lab organization from Intel for processing and visualizing \ac{PC}s. It supports both PyTorch and Tensorflow as the 3D machine learning base tool and supports GPU acceleration for computationally expensive 3D operations.
...
For 3D object detection only the PointPillars and PointRCNN models are implemented and pretrained in both PyTorch and Tensorflow implementations.
